...
type CalculatorStep = "LAYOUT" | "PACKAGE" | "DIMENSIONS" | "ESTIMATE";
...
const KitchenCalculatorWizard: React.FC = () => {
  const navigate = useNavigate();

  // Wizard state management starting directly at LAYOUT selection
  const [step, setStep] = useState<CalculatorStep>("LAYOUT");
  ...
  // Render step headers progress percentage
      ...
      <main className="flex-grow pb-16 pt-24">
        ...
        <div className="max-w-5xl mx-auto px-6 mt-8">
          ...
          {step !== "ESTIMATE" && (
            <button
              onClick={() => {
                if (step === "LAYOUT") navigate("/kitchen-price-calculator");
...
export default KitchenCalculatorWizard;
