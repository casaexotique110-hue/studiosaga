      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <p className="text-sm uppercase tracking-wider text-luxury-gold mb-4">Base Tier</p>
            <h1 className="text-4xl md:text-6xl font-extralight tracking-wide mb-8 uppercase">
              {size?.toUpperCase()} Package
            </h1>
            <p className="text-xl text-muted-foreground font-light leading-relaxed">
              Essential design solutions for your {size?.toUpperCase()} home. Quality fundamentals that create comfortable, functional spaces.
            </p>
          </div>
...
export default InteriorKitBase;
