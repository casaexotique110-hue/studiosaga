    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-luxury-gold/30">
      ...
      <div className="relative pt-32 pb-20 bg-stone-50 dark:bg-stone-950">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            Discover the aesthetic that speaks to your soul.
            From raw industrial lofts to serene Scandinavian retreats.
          </motion.p>
        </div>
      </div>
              ...
              >
                ...
                <div className="w-full md:w-1/2">
                  <div className="space-y-4">
                    ...
                    {/* MAIN IMAGE */}
                    <div className="relative group overflow-hidden rounded-3xl shadow-xl aspect-[4/5] md:aspect-[3/4] bg-white">
                      <img
                        src={
        ...
        <div className="bg-stone-900 text-stone-50 py-24 mt-20 text-center">
          <div className="container mx-auto px-6">
            ...
            <p className="text-stone-400 max-w-2xl mx-auto mb-10 font-light">
              Our designers specialize in blending these
              styles to create something uniquely yours.
              Book a consultation to find your signature
              palette.
            </p>
