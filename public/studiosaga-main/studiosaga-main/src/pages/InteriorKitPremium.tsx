...
const InteriorKitPremium = () => {
  const { size } = useParams();

  const features = [
    "Luxury furniture and bespoke pieces",
    "Statement lighting collections",
    "Premium imported materials and finishes",
    "Custom built-in solutions",
    "Designer motorized window treatments",
    "Unlimited design consultations",
    "Photorealistic 3D visualization",
    "Complete styling and art curation",
      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <p className="text-sm uppercase tracking-wider text-luxury-gold mb-4">Premium Tier</p>
            <h1 className="text-4xl md:text-6xl font-extralight tracking-wide mb-8 uppercase">
              {size?.toUpperCase()} Package
            </h1>
            <p className="text-xl text-muted-foreground font-light leading-relaxed">
              Luxury design solutions for your {size?.toUpperCase()} home. Bespoke quality and meticulous attention to every detail.
            </p>
          </div>
...
export default InteriorKitPremium;
